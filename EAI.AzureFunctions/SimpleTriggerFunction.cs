...
{
    public abstract class SimpleTriggerFunction<requestT> : Function
    {
        ...
        protected async Task RunQueueRequestAsync(FunctionContext functionContext, requestT requestMessage)
        {
            ...
            try
            {
                ...
                Log?.Start<Info>(nameof(requestMessage), requestMessage);
